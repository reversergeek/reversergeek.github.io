...
TODO: use hardware breakpoints on the cipher text to find all reads from it. Look at the refrence graphs from IDA to see how deep the functions calls go, then step though them giving IDA 
